class mt:
    ...
    def heart(self, word):
        self.number_of_state = self.fifth_condition     # привязываем первое состояние к номеру состояния,
        ...
        """
        word = list('L' + word + 'L')   # в данной строке мы добавляем на края лямбды, и преобразуем слово
