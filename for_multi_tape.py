class mt_for_multi_tape:
    ...
    def first_condition(self):
        ...
        if self.letter_on_first_ribbon == 'a':
            ...
            self.state = self.eight_condition
    ...
    def sixth_condition(self):
        ...
        if self.letter_on_third_ribbon == '1':
            ...
            self.direction_of_second_ribbon, self.direction_of_first_ribbon = '.', 'stop'
    ...
    def eight_condition(self):
        """
                Переходим в состояния с буквой C, если встречаем букву A
            переходим в состояние 2, иначе в 1.
        """
        self.number_state = '9'
        self.direction_of_first_ribbon = '>'
    ...
    def heart(self, word_on_first_ribbon, bot):
        ...
        while True:
            ...
            if self.direction_of_first_ribbon == '>':   # двигаемся на ПЕРВОЙ ленте
                ...
                self.result_word = ''.join(word_on_first_ribbon).replace('_', '').replace('a', '').replace('d', '').replace('c', '').replace('b', '')
                return
